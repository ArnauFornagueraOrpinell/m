    ...
    export default {
        ...
        methods: {
            confirmOrder() {
                ...
                fetch('https://192.168.1.158:3002/save', {
                    method: 'POST',
                    headers: {
            ...
            getPickings() {
                ...
                // fetch(`https://192.168.1.158:3002/page?page=1&length=${page_length}`)
                // .then(response => response.json())
                // .then(data => {
                //     this.pickings = data;
                ...
                fetch(`https://192.168.1.158:3002/page?length=${page_length}`)
                .then(response => response.json())
                .then(data => {
            ...
            getPickingsPage(page_number) {
                ...
                fetch(`https://192.168.1.158:3002/page?page=${page_number}&length=${page_length}`)
                .then(response => response.json())
                .then(data => {
                    this.data = data.data;
                    this.data = data.data;
            ...
            deleteItems() {
                ...
                fetch('https://192.168.1.158:3002/delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
